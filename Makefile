...
REGTESTSOURCES = split_ideal_membership_regression.cpp $(filter-out main.cpp,$(SOURCES))
...
regression-split-ideal: $(patsubst %.cpp,objs-regression/%.o,$(REGTESTSOURCES))
	$(CXX) $^ -o $@ $(LDFLAGS)
...
clean:
	...
	rm -f regression-split-ideal objs-regression/*
