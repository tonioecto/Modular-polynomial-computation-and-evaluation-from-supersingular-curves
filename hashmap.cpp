...
void inner_order_invariant_computation_from_gram(NTL::ZZ *IntList, NTL::mat_ZZ gram_input, quatlat order, quat *small) {
    // (void) small;
    // (void) order;
    mat_t Gram;
    mat_t Red;
...
Key order_invariant_computation_from_gram(quatlat order, NTL::mat_ZZ Gram, quat *small) {
        ...
        // std::cout << "t =" << t << "\n";
        // auto t = tic();
        inner_order_invariant_computation_from_gram(IntList, Gram, order, small);
        // clock_t t2 = clock();
        // std::cout << "t2 = " << t2 << "\n";
        // std::cout << "t2 - t =" << t2 - t << "\n";
        // std::cout << IntList[0] << IntList[1] << IntList[2] << "\n";
